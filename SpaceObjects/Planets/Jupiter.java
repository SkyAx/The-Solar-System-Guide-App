...
public final class Jupiter extends SpaceObject implements Planet{

    public Jupiter(String name, String type, int countSatellite, long weight, long area, int lengthOfCircle, double maxTemperature, double gravity) {
